...
def list_concept(t_url):
    ...
    print(board_hq.h3.span.text)
    span = board_hq.find("span", class_="board-xj arr-fall")
    print(span)
    print(board_hq.p)
    # for child in board_hq.h3.contents:
    #     print(child)
    # print(board_hq.h3.span.string)
    # print(board_hq.span.string)
